#!/usr/bin/env sh
# Universal installer for mftparse. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/mftparse.git"
echo "Installing mftparse ..."
