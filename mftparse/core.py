"""MFTPARSE core — Analyze an NTFS $MFT CSV for timestomping and suspicious file activity."""
...
RULES = [
    ("MFT-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("MFT-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("MFT-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
